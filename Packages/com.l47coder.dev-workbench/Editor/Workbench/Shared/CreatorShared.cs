...
namespace DevWorkbench.Editor
{
    ...
    // Moved here from ManagerCreatorState / ComponentCreatorState inner classes.
    // Both Creator pages and both State classes reference these directly.
    ...
    // ── Shared Creator page drawing utilities ─────────────────────────────────
    // All constants, styles, and static drawing methods that are identical in
    // ManagerCreatorPage and ComponentCreatorPage live here.
