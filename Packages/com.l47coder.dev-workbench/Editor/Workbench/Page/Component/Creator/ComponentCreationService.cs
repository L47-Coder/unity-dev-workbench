...
namespace DevWorkbench.Editor
{
    internal static class ComponentCreationService
    {
        ...
        private static void WriteConfigGeneratedCode(ComponentCreationPlan plan)
        {
            ...
            sb.AppendLine($"public sealed partial class {cfg}");
            sb.AppendLine("{");
            sb.AppendLine($"    internal List<{dc}> EditorConfigs => {f};");
            sb.AppendLine("}");
            sb.AppendLine("#endif");
            sb.AppendLine();
            sb.AppendLine($"public sealed partial class {cfg} : BaseComponentConfig, IConfigListOwner");
            sb.AppendLine("{");
            sb.AppendLine("    [SerializeField]");
            sb.AppendLine($"    private List<{dc}> {f} = new();");
            sb.AppendLine();
            sb.AppendLine($"    Type IConfigListOwner.ConfigItemType => typeof({dc});");
            sb.AppendLine($"    IList IConfigListOwner.GetConfigList() => {f};");
            sb.AppendLine();
