...
namespace DevWorkbench.Editor
{
    internal static class ManagerCreationService
    {
        ...
        private static void WriteConfigGeneratedCode(ManagerCreationPlan plan)
        {
            ...
            builder.AppendLine();
            builder.AppendLine($"public sealed partial class {plan.ConfigClassName} : BaseManagerConfig, IConfigListOwner");
            builder.AppendLine("{");
            ...
            builder.AppendLine();
            builder.AppendLine($"    Type IConfigListOwner.ConfigItemType => typeof({plan.ManagerDataStructName});");
            builder.AppendLine($"    IList IConfigListOwner.GetConfigList() => {GeneratedConfigListFieldName};");
            builder.AppendLine();
