...
namespace DevWorkbench.Editor
{
    internal static class ManagerCreationService
    {
        ...
        private static void WriteConfigGeneratedCode(ManagerCreationPlan plan)
        {
            ...
            builder.AppendLine();
            builder.AppendLine($"    public override Type ConfigItemType => typeof({plan.ManagerDataStructName});");
            builder.AppendLine($"    public override IList GetConfigList() => {GeneratedConfigListFieldName};");
            builder.AppendLine();
        ...
        private static void WriteRefresherCode(ManagerCreationPlan plan)
        {
            ...
            builder.AppendLine();
            builder.AppendLine($"        var list = (List<{plan.ManagerDataStructName}>)cfg.GetConfigList();");
            builder.AppendLine();
